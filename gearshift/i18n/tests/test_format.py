...
from gearshift.i18n.format import *
...
#    assert format_decimal(4.9, 0, "en") == "5"
    ...
    assert format_decimal(4.9, locale="en_US") == "4.9"
    assert format_decimal(5.0, locale="en_US") == "5"
    assert format_decimal(5.1, locale="de") == "5,1"
    ...
    assert format_decimal(5000000.78781, locale="en_US") == "5,000,000.788"
    assert format_decimal(5000000.78781, locale="de") == "5.000.000,788"

    assert format_currency(5000000.78781, locale="en_US") == "5,000,000.79"
    assert format_currency(5000000.78781, locale="de") == "5.000.000,79"
...
def test_format_date():
    ...
    assert format_date(dt, "full", "eo") == u"sabato, 5-a de februaro 2005"

    assert format_date(dt, "long", "de") == u"5. Februar 2005"
    assert format_date(dt, "medium", "de") == u"05.02.2005"
    assert format_date(dt, "short", "de") == u"05.02.05"
    assert format_date(dt, "full", "de") == u"Samstag, 5. Februar 2005"
...
def test_diff_locale_format_date():
    assert format_date(dt, "short", "en_US") == "2/5/05"
    print format_date(dt, "short", "en_GB")
